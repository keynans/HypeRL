...
class HalfCheetahVelMediumEnv(HalfCheetahEnv):
    ...
    def __init__(self, task={}, n_tasks=2,n_train_tasks=2 ,n_eval_tasks=2, randomize_tasks=True):
        ...
        test_tasks = self.sample_test_tasks(n_eval_tasks,1338)
        self.norm = self.get_norm(tasks)
        self.tasks = tasks + test_tasks
        self._goal_vel = self.tasks[0].get('velocity', 0.0)
        self._goal = self._goal_vel
        super(HalfCheetahVelMediumEnv, self).__init__()
