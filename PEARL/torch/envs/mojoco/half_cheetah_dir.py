...
class HalfCheetahDirEnv(HalfCheetahEnv):
    ...
    """
    def __init__(self, task={}, n_tasks=2,n_train_tasks=2 ,n_eval_tasks=2, randomize_tasks=False):
        directions = [-1, 1]
        self.tasks = [{'direction': direction} for direction in directions]
        self.test_tasks = [{'direction': direction} for direction in directions]
        self._task = task
