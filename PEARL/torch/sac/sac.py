...
class PEARLSoftActorCritic(MetaRLAlgorithm):
    def __init__(
        ...
        self.copy_params(self.target_vf, self.vf)
    ...
    def _take_step(self, indices, context):
        ...
        v_pred = self.vf(obs, None, task_z.detach())
        # get targets for use in V and Q updates
        with torch.no_grad():
            target_v_values = self.target_vf(next_obs, None, task_z)
        ...
        # dont waist compute time for actor calc
