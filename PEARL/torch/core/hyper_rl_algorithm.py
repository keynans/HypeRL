...
from rlkit.samplers.hyper_in_place import HyperInPlacePathSampler
from rlkit.torch import pytorch_util as ptu


class HyperMetaRLAlgorithm(metaclass=abc.ABCMeta):
    def __init__(
        self,
        env,
        agent,
        ...
        self.evaluations = {'test': [], 'train':[]}
        self.file_name=file_name

        self.sampler = HyperInPlacePathSampler(
            env=env,
            policy=agent,
        ...
        for it_ in gt.timed_for(
            ...
            if it_ == 0:
                ...
                for idx in self.train_tasks:
                    ...
                    self.agent.z = self.env.get_tasks_tensors([idx])
            ...
            for i in range(self.num_tasks_sample):
                ...
                if self.num_extra_rl_steps_posterior > 0:
                    self.collect_data(self.num_extra_rl_steps_posterior, 1, np.inf)
    ...
    def _try_to_eval(self, epoch):
        ...
        if self._can_evaluate():
            ...
            step_time = times_itrs['train_step'][-1]
            ...
            logger.record_tabular('Step Train Time (s)', step_time)
